...
entity base_video_to_axis_0_0_full_dp_ram is
  port (
  ...
  attribute ORIG_REF_NAME of base_video_to_axis_0_0_full_dp_ram : entity is "full_dp_ram";
end base_video_to_axis_0_0_full_dp_ram;

architecture STRUCTURE of base_video_to_axis_0_0_full_dp_ram is
...
ram: entity work.base_video_to_axis_0_0_full_dp_ram
     port map (
      CO(0) => rempty,
      Q(0) => w2r_wptr2(12),
      S(0) => ram_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_0_0_video_to_axis is
  port (
    q_b : out STD_LOGIC_VECTOR ( 9 downto 0 );
    overflow : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_video_to_axis_0_0_video_to_axis : entity is "video_to_axis";
end base_video_to_axis_0_0_video_to_axis;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_0_0_video_to_axis_v1_0 is
  port (
    q_b : out STD_LOGIC_VECTOR ( 9 downto 0 );
    overflow : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_video_to_axis_0_0_video_to_axis_v1_0 : entity is "video_to_axis_v1_0";
end base_video_to_axis_0_0_video_to_axis_v1_0;

architecture STRUCTURE of base_video_to_axis_0_0_video_to_axis_v1_0 is
begin
video_to_axis_inst: entity work.base_video_to_axis_0_0_video_to_axis
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_0_0 is
  port (
    vid_clk : in STD_LOGIC;
    vid_rstn : in STD_LOGIC;
    vid_ce : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of base_video_to_axis_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_video_to_axis_0_0 : entity is "base_video_to_axis_0_0,video_to_axis_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of base_video_to_axis_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of base_video_to_axis_0_0 : entity is "video_to_axis_v1_0,Vivado 2021.1";
end base_video_to_axis_0_0;

architecture STRUCTURE of base_video_to_axis_0_0 is
...
begin
inst: entity work.base_video_to_axis_0_0_video_to_axis_v1_0
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
