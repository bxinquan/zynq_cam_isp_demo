...
namespace eval ::optrace {
  variable script "D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0.tcl"
...
OPTRACE "base_axi_smc_0_synth_1" START { ROLLUP_AUTO }
...
read_ip -quiet D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.srcs/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1 -new_name base_axi_smc_0 -ip [get_ips base_axi_smc_0]]
...
synth_design -top base_axi_smc_0 -part xc7z020clg400-2 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix base_axi_smc_0_ base_axi_smc_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ base_axi_smc_0_stub.v
 lappend ipCachedFiles base_axi_smc_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ base_axi_smc_0_stub.vhdl
 lappend ipCachedFiles base_axi_smc_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ base_axi_smc_0_sim_netlist.v
 lappend ipCachedFiles base_axi_smc_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ base_axi_smc_0_sim_netlist.vhdl
 lappend ipCachedFiles base_axi_smc_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp base_axi_smc_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips base_axi_smc_0]
 }
...
rename_ref -prefix_all base_axi_smc_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef base_axi_smc_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "base_axi_smc_0_synth_1_synth_report_utilization_0" "report_utilization -file base_axi_smc_0_utilization_synth.rpt -pb base_axi_smc_0_utilization_synth.pb"
OPTRACE "synth reports" END { }

if { [catch {
  file copy -force D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0.dcp d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0_stub.v d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0_stub.vhdl d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0_sim_netlist.v d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_axi_smc_0_synth_1/base_axi_smc_0_sim_netlist.vhdl d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.ip_user_files/ip/base_axi_smc_0]} {
  catch { 
    file copy -force d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.v D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.ip_user_files/ip/base_axi_smc_0
  }
}

if {[file isdir D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.ip_user_files/ip/base_axi_smc_0]} {
  catch { 
    file copy -force d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axi_smc_0/base_axi_smc_0_stub.vhdl D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.ip_user_files/ip/base_axi_smc_0
  }
}
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "base_axi_smc_0_synth_1" END { }
