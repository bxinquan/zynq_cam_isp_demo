set_property SRC_FILE_INFO {cfile:D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.srcs/constrs_base/new/base.xdc rfile:../../../zynq_cam_isp_demo.srcs/constrs_base/new/base.xdc id:1} [current_design]
set_property src_info {type:XDC file:1 line:5 export:INPUT save:INPUT read:READ} [current_design]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets cam_pclk_IBUF]
set_property src_info {type:XDC file:1 line:6 export:INPUT save:INPUT read:READ} [current_design]
set_clock_groups -async -group [get_clocks cam_pclk] -group [get_clocks clk_fpga_0] -group [get_clocks clk_fpga_1] -group [get_clocks camif_xclk_base_clk_wiz_0_0] -group [get_clocks isp_pclk_base_clk_wiz_0_0] -group [get_clocks lcd_clk_base_clk_wiz_0_0] -group [get_clocks dvi_clk_base_clk_wiz_1_0_1]
