...
set_clock_groups -async -group [get_clocks cam_pclk] -group [get_clocks clk_fpga_0] -group [get_clocks clk_fpga_1] -group [get_clocks camif_xclk_base_clk_wiz_0_0] -group [get_clocks isp_pclk_base_clk_wiz_0_0]
