...
HD_PWD='D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_v_vid_in_axi4s_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_v_vid_in_axi4s_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_v_vid_in_axi4s_1_0.tcl
