...
HD_PWD='D:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.runs/base_video_to_axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_video_to_axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_video_to_axis_0_0.tcl
