...
--               d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_video_to_axis_2_0/base_video_to_axis_2_0_sim_netlist.vhdl
...
entity base_video_to_axis_2_0_full_dp_ram is
  port (
  ...
  attribute ORIG_REF_NAME of base_video_to_axis_2_0_full_dp_ram : entity is "full_dp_ram";
end base_video_to_axis_2_0_full_dp_ram;

architecture STRUCTURE of base_video_to_axis_2_0_full_dp_ram is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_2_0_async_fifo is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_video_to_axis_2_0_async_fifo : entity is "async_fifo";
end base_video_to_axis_2_0_async_fifo;

architecture STRUCTURE of base_video_to_axis_2_0_async_fifo is
...
ram: entity work.base_video_to_axis_2_0_full_dp_ram
     port map (
      CO(0) => rempty,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_2_0_video_to_axis is
  port (
    q_b : out STD_LOGIC_VECTOR ( 25 downto 0 );
    overflow : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_video_to_axis_2_0_video_to_axis : entity is "video_to_axis";
end base_video_to_axis_2_0_video_to_axis;

architecture STRUCTURE of base_video_to_axis_2_0_video_to_axis is
...
begin
  m_axis_tvalid <= \^m_axis_tvalid\;
fifo: entity work.base_video_to_axis_2_0_async_fifo
     port map (
      aclk => aclk,
      aresetn => aresetn,
      aresetn_0 => fifo_n_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_2_0_video_to_axis_v1_0 is
  port (
    q_b : out STD_LOGIC_VECTOR ( 25 downto 0 );
    overflow : out STD_LOGIC;
    m_axis_tvalid : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_video_to_axis_2_0_video_to_axis_v1_0 : entity is "video_to_axis_v1_0";
end base_video_to_axis_2_0_video_to_axis_v1_0;

architecture STRUCTURE of base_video_to_axis_2_0_video_to_axis_v1_0 is
begin
video_to_axis_inst: entity work.base_video_to_axis_2_0_video_to_axis
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_video_to_axis_2_0 is
  port (
    vid_clk : in STD_LOGIC;
    vid_rstn : in STD_LOGIC;
    vid_ce : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of base_video_to_axis_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_video_to_axis_2_0 : entity is "base_video_to_axis_2_0,video_to_axis_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of base_video_to_axis_2_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of base_video_to_axis_2_0 : entity is "video_to_axis_v1_0,Vivado 2021.1";
end base_video_to_axis_2_0;

architecture STRUCTURE of base_video_to_axis_2_0 is
...
begin
inst: entity work.base_video_to_axis_2_0_video_to_axis_v1_0
     port map (
      aclk => aclk,
      aresetn => aresetn,
      m_axis_tready => m_axis_tready,
