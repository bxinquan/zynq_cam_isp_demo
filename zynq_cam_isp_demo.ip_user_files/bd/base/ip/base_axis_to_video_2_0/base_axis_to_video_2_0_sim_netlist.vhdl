...
--               d:/Work/fpga/zynq_cam_isp_demo/zynq_cam_isp_demo.gen/sources_1/bd/base/ip/base_axis_to_video_2_0/base_axis_to_video_2_0_sim_netlist.vhdl
...
entity base_axis_to_video_2_0_full_dp_ram is
  port (
    wr_flag : out STD_LOGIC;
    S : out STD_LOGIC_VECTOR ( 3 downto 0 );
    rd_flag : out STD_LOGIC;
    q_b : out STD_LOGIC_VECTOR ( 24 downto 0 );
    ...
    underflow_0 : in STD_LOGIC_VECTOR ( 11 downto 0 );
    raddr_reg : in STD_LOGIC_VECTOR ( 10 downto 0 );
    underflow_1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    aclk : in STD_LOGIC;
    vid_clk : in STD_LOGIC;
    wdata_a : in STD_LOGIC_VECTOR ( 25 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_axis_to_video_2_0_full_dp_ram : entity is "full_dp_ram";
end base_axis_to_video_2_0_full_dp_ram;

architecture STRUCTURE of base_axis_to_video_2_0_full_dp_ram is
  signal mem_reg_1_n_25 : STD_LOGIC;
  signal \^q_b\ : STD_LOGIC_VECTOR ( 24 downto 0 );
...
begin
  q_b(24 downto 0) <= \^q_b\(24 downto 0);
  rd_flag <= \^rd_flag\;
  wr_flag <= \^wr_flag\;
...
mem_reg_1: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      DIADI(7 downto 0) => wdata_a(25 downto 18),
      ...
      DOBDO(5 downto 0) => \^q_b\(23 downto 18),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_axis_to_video_2_0_video_timing_gen is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_axis_to_video_2_0_video_timing_gen : entity is "video_timing_gen";
end base_axis_to_video_2_0_video_timing_gen;

architecture STRUCTURE of base_axis_to_video_2_0_video_timing_gen is
  ...
  signal \line_cnt[9]_i_8_n_0\ : STD_LOGIC;
  ...
  signal vid_active_video12_in : STD_LOGIC;
  ...
  signal vid_hsync_i_5_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \line_cnt[5]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \line_cnt[6]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \line_cnt[9]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \line_cnt[9]_i_4\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \line_cnt[9]_i_5\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \pix_cnt[10]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pix_cnt[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \pix_cnt[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pix_cnt[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \pix_cnt[5]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \pix_cnt[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \pix_cnt[7]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \pix_cnt[9]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of vid_hsync_i_5 : label is "soft_lutpair12";
begin
...
\line_cnt[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\line_cnt[9]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\line_cnt[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
\line_cnt[9]_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFAFBFFFAFAFFFFF"
    )
        port map (
...
\line_cnt[9]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\pix_cnt[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\pix_cnt[10]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2223FFFFFFFFFFFF"
    )
        port map (
      I0 => \line_cnt[9]_i_3_n_0\,
...
\pix_cnt[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"48"
    )
        port map (
...
vid_active_video_i_1: unisim.vcomponents.LUT6
    generic map(
...
vid_hsync_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
vid_hsync_i_4: unisim.vcomponents.LUT6
    generic map(
...
vid_hsync_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_axis_to_video_2_0_async_fifo is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_axis_to_video_2_0_async_fifo : entity is "async_fifo";
end base_axis_to_video_2_0_async_fifo;

architecture STRUCTURE of base_axis_to_video_2_0_async_fifo is
...
ram: entity work.base_axis_to_video_2_0_full_dp_ram
     port map (
      ...
      underflow => \^underflow\,
      underflow_0(11 downto 0) => w2r_wptr2(11 downto 0),
      underflow_1(0) => \raddr_reg__0\(11),
      vid_clk => vid_clk,
      w2r_wfull1_reg(0) => \waddr_reg__0\(11),
      ...
      wdata_a(25 downto 0) => wdata_a(25 downto 0),
      wfull => \^wfull\,
      wr_flag => wr_flag
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_axis_to_video_2_0_axis_to_video is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_axis_to_video_2_0_axis_to_video : entity is "axis_to_video";
end base_axis_to_video_2_0_axis_to_video;

architecture STRUCTURE of base_axis_to_video_2_0_axis_to_video is
  signal active_video_w : STD_LOGIC;
...
fifo: entity work.base_axis_to_video_2_0_async_fifo
     port map (
      aclk => aclk,
      active_video_w => active_video_w,
      aresetn => aresetn,
      ...
      q_b(24) => tuser,
      q_b(23 downto 0) => vid_data(23 downto 0),
...
timing: entity work.base_axis_to_video_2_0_video_timing_gen
     port map (
      active_video_w => active_video_w,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_axis_to_video_2_0_axis_to_video_v1_0 is
  port (
    locked : out STD_LOGIC;
    vid_data : out STD_LOGIC_VECTOR ( 23 downto 0 );
    vid_hsync : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of base_axis_to_video_2_0_axis_to_video_v1_0 : entity is "axis_to_video_v1_0";
end base_axis_to_video_2_0_axis_to_video_v1_0;

architecture STRUCTURE of base_axis_to_video_2_0_axis_to_video_v1_0 is
begin
axis_to_video_inst: entity work.base_axis_to_video_2_0_axis_to_video
     port map (
      aclk => aclk,
      aresetn => aresetn,
      locked => locked,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity base_axis_to_video_2_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of base_axis_to_video_2_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of base_axis_to_video_2_0 : entity is "base_axis_to_video_2_0,axis_to_video_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of base_axis_to_video_2_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of base_axis_to_video_2_0 : entity is "axis_to_video_v1_0,Vivado 2021.1";
end base_axis_to_video_2_0;

architecture STRUCTURE of base_axis_to_video_2_0 is
  ...
  attribute X_INTERFACE_PARAMETER of vid_clk : signal is "XIL_INTERFACENAME vid_clk, ASSOCIATED_RESET vid_rstn, ASSOCIATED_BUSIF video_out, FREQ_HZ 74250000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_1_clk_out1, INSERT_VIP 0";
...
begin
inst: entity work.base_axis_to_video_2_0_axis_to_video_v1_0
     port map (
      aclk => aclk,
      aresetn => aresetn,
      locked => locked,
      ...
      vid_rstn => vid_rstn,
      vid_vsync => vid_vsync,
      wdata_a(25) => s_axis_tuser,
      wdata_a(24) => s_axis_tlast,
      wdata_a(23 downto 0) => s_axis_tdata(23 downto 0)
    );
end STRUCTURE;
