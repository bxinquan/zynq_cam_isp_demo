...
HD_PWD='D:/Work/fpga/zynq_camera_vdma_lcd/zynq_camera_vdma_lcd.runs/design_1_v_tc_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_v_tc_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_v_tc_2_0.tcl
