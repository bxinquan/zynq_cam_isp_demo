...
HD_PWD='D:/Work/fpga/zynq_camera_vdma_lcd/zynq_camera_vdma_lcd.runs/design_1_xil_camif_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xil_camif_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xil_camif_0_0.tcl
