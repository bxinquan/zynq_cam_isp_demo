...
set_clock_groups -async -group [get_clocks cam_pclk] -group [get_clocks clk_fpga_0] -group [get_clocks cam_xclk_design_1_clk_wiz_0_0] -group [get_clocks isp_pclk_design_1_clk_wiz_0_0]
