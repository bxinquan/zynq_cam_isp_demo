...
proc init_gui { IPINST } {
  ...
  #Adding Page
  set VIP [ipgui::add_page $IPINST -name "VIP"]
  ipgui::add_param $IPINST -name "BITS" -parent ${VIP}
  ipgui::add_param $IPINST -name "WIDTH" -parent ${VIP}
  ipgui::add_param $IPINST -name "HEIGHT" -parent ${VIP}
  set FEATURE_FULL [ipgui::add_param $IPINST -name "FEATURE_FULL" -parent ${VIP}]
  set_property tooltip {Feature Full (Hist_Equ)} ${FEATURE_FULL}
