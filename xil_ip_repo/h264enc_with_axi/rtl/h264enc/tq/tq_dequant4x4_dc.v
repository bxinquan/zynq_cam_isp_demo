...
assign product_tmp02_w = scale02_i * ({de_mf00_w,4'b0});
assign product_tmp03_w = scale03_i * ({de_mf00_w,4'b0});
assign product_tmp10_w = scale10_i * ({de_mf00_w,4'b0});
assign product_tmp11_w = scale11_i * ({de_mf00_w,4'b0});
assign product_tmp12_w = scale12_i * ({de_mf00_w,4'b0});
assign product_tmp13_w = scale13_i * ({de_mf00_w,4'b0});
assign product_tmp20_w = scale20_i * ({de_mf00_w,4'b0});
assign product_tmp21_w = scale21_i * ({de_mf00_w,4'b0});
assign product_tmp22_w = scale22_i * ({de_mf00_w,4'b0});
assign product_tmp23_w = scale23_i * ({de_mf00_w,4'b0});
assign product_tmp30_w = scale30_i * ({de_mf00_w,4'b0});
assign product_tmp31_w = scale31_i * ({de_mf00_w,4'b0});
assign product_tmp32_w = scale32_i * ({de_mf00_w,4'b0});
assign product_tmp33_w = scale33_i * ({de_mf00_w,4'b0});

assign coeff00_o_w = (qpdiv6_i < 6)? ((product_tmp00_w + bias_w) >> shift_len_w) : (product_tmp00_w << shift_len_w);
assign coeff01_o_w = (qpdiv6_i < 6)? ((product_tmp01_w + bias_w) >> shift_len_w) : (product_tmp01_w << shift_len_w);
assign coeff02_o_w = (qpdiv6_i < 6)? ((product_tmp02_w + bias_w) >> shift_len_w) : (product_tmp02_w << shift_len_w);
assign coeff03_o_w = (qpdiv6_i < 6)? ((product_tmp03_w + bias_w) >> shift_len_w) : (product_tmp03_w << shift_len_w);
assign coeff10_o_w = (qpdiv6_i < 6)? ((product_tmp10_w + bias_w) >> shift_len_w) : (product_tmp10_w << shift_len_w);
assign coeff11_o_w = (qpdiv6_i < 6)? ((product_tmp11_w + bias_w) >> shift_len_w) : (product_tmp11_w << shift_len_w);
assign coeff12_o_w = (qpdiv6_i < 6)? ((product_tmp12_w + bias_w) >> shift_len_w) : (product_tmp12_w << shift_len_w);
assign coeff13_o_w = (qpdiv6_i < 6)? ((product_tmp13_w + bias_w) >> shift_len_w) : (product_tmp13_w << shift_len_w);
assign coeff20_o_w = (qpdiv6_i < 6)? ((product_tmp20_w + bias_w) >> shift_len_w) : (product_tmp20_w << shift_len_w);
assign coeff21_o_w = (qpdiv6_i < 6)? ((product_tmp21_w + bias_w) >> shift_len_w) : (product_tmp21_w << shift_len_w);
assign coeff22_o_w = (qpdiv6_i < 6)? ((product_tmp22_w + bias_w) >> shift_len_w) : (product_tmp22_w << shift_len_w);
assign coeff23_o_w = (qpdiv6_i < 6)? ((product_tmp23_w + bias_w) >> shift_len_w) : (product_tmp23_w << shift_len_w);
assign coeff30_o_w = (qpdiv6_i < 6)? ((product_tmp30_w + bias_w) >> shift_len_w) : (product_tmp30_w << shift_len_w);
assign coeff31_o_w = (qpdiv6_i < 6)? ((product_tmp31_w + bias_w) >> shift_len_w) : (product_tmp31_w << shift_len_w);
assign coeff32_o_w = (qpdiv6_i < 6)? ((product_tmp32_w + bias_w) >> shift_len_w) : (product_tmp32_w << shift_len_w);
assign coeff33_o_w = (qpdiv6_i < 6)? ((product_tmp33_w + bias_w) >> shift_len_w) : (product_tmp33_w << shift_len_w);
...
always @(*)
	case (qpdiv6_i)
		4'b0000:shift_len_w = 3'd6;
		4'b0001:shift_len_w = 3'd5;
		4'b0010:shift_len_w = 3'd4;
		4'b0011:shift_len_w = 3'd3;
		4'b0100:shift_len_w = 3'd2;
		default:shift_len_w = qpdiv6_i - 3'd6;
	endcase

always @(*)
	case (qpmod6_i)
		3'b000:de_mf00_w = 6'd10;
		3'b001:de_mf00_w = 6'd11;
		3'b010:de_mf00_w = 6'd13;
		3'b011:de_mf00_w = 6'd14;
		3'b100:de_mf00_w = 6'd16;
		3'b101:de_mf00_w = 6'd18;
		default: de_mf00_w = 6'd0;
	endcase
