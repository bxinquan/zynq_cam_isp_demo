...
set_clock_groups -async -group [get_clocks cam_pclk] \
        ...
        -group [get_clocks camif_xclk_design_1_clk_wiz_0_0] \
...
#camera2
#set_property -dict {PACKAGE_PIN P19 IOSTANDARD LVCMOS33} [get_ports cam_rst_n]
#set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports cam_pwdn]
#set_property -dict {PACKAGE_PIN B19 IOSTANDARD LVCMOS33} [get_ports {cam_data[0]}]
#set_property -dict {PACKAGE_PIN H20 IOSTANDARD LVCMOS33} [get_ports {cam_data[1]}]
#set_property -dict {PACKAGE_PIN T19 IOSTANDARD LVCMOS33} [get_ports {cam_data[2]}]
#set_property -dict {PACKAGE_PIN R19 IOSTANDARD LVCMOS33} [get_ports {cam_data[3]}]
#set_property -dict {PACKAGE_PIN B20 IOSTANDARD LVCMOS33} [get_ports {cam_data[4]}]
#set_property -dict {PACKAGE_PIN C20 IOSTANDARD LVCMOS33} [get_ports {cam_data[5]}]
#set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports {cam_data[6]}]
#set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports {cam_data[7]}]
#set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports cam_active_video]
#set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports cam_vsync]
...
#iic for camera2
#set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports iic_scl_io]
#set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports iic_sda_io]
