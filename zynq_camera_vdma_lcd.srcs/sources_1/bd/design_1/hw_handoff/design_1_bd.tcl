...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_cam_xclk [get_bd_pins clk_wiz_0/cam_xclk] [get_bd_pins xil_camif_0/cam_xclk]
