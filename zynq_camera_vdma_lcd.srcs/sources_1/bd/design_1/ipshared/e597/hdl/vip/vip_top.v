...
(
	...
	input hist_equ_en, sobel_en, yuv2rgb_en, crop_en, dscale_en, osd_en,
...
`ifdef USE_OSD
	...
	assign osd_href_o = osd_en ? osd_href : dscale_href_o;
	assign osd_vsync_o = osd_en ? osd_vsync : dscale_vsync_o;
	assign osd_r_o = osd_en ? osd_r : dscale_r_o;
	assign osd_g_o = osd_en ? osd_g : dscale_g_o;
	assign osd_b_o = osd_en ? osd_b : dscale_b_o;
`else
	assign osd_pclk_o = dscale_pclk_o;
...
`endif
	...
	assign out_pclk = osd_pclk_o;
	assign out_href = osd_href_o;
	assign out_vsync = osd_vsync_o;
	assign out_r = osd_r_o;
	assign out_g = osd_g_o;
	assign out_b = osd_b_o;
endmodule
