...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_camif
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_camif_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_isp_lite
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_isp_lite_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_vip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_vip_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_vip
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_vip_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_camif
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_camif_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = xil_isp_lite
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = xil_isp_lite_1
END
