...
#define ISP_REG_STAT_AE_HIST_ADDR(b)     (1*(1<<((b)+4)))
#define ISP_REG_STAT_AE_HIST_SIZE(b)     (4*(1<<((b)+2)))
#define ISP_REG_STAT_AWB_HIST_ADDR(b)    (2*(1<<((b)+4)))
#define ISP_REG_STAT_AWB_HIST_SIZE(b)    (3*(1<<((b)+2)))
...
#define ISP_REG_TOP_EN_BIT_EE_EN            (1<<9)
#define ISP_REG_TOP_EN_BIT_STAT_AE_EN       (1<<10)
#define ISP_REG_TOP_EN_BIT_STAT_AWB_EN      (1<<11)
